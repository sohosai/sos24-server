...
impl From<(WithDate<Invitation>, WithDate<User>, WithDate<Project>)> for InvitationDto {
    fn from(
        (invitation_entity, inviter_entity, project_entity): (
            WithDate<Invitation>,
            WithDate<User>,
            WithDate<Project>,
        ),
...
impl From<InvitationPositionDto> for InvitationPosition {
    fn from(dto: InvitationPositionDto) -> Self {
        match dto {
            InvitationPositionDto::Owner => InvitationPosition::Owner,
            InvitationPositionDto::SubOwner => InvitationPosition::SubOwner,
        }
    }
}
