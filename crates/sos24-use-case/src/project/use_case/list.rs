...
use crate::{context::Context, project::dto::ProjectWithOwnersDto};
...
impl<R: Repositories> ProjectUseCase<R> {
    pub async fn list(
        &self,
        ctx: &Context,
    ) -> Result<Vec<ProjectWithOwnersDto>, ProjectUseCaseError> {
        ...
        for raw_project in raw_project_list {
            ...
            project_list.push(ProjectWithOwnersDto::from((
                raw_project,
                raw_owner,
                raw_sub_owner,
            )));
